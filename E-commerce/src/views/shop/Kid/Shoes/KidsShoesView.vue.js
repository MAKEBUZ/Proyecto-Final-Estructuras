...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_7 = __VLS_asFunctionalComponent(__VLS_6, new __VLS_6({ category: ("Kids"), subcategory: ("Shoes"), }));
    const __VLS_8 = __VLS_7({ category: ("Kids"), subcategory: ("Shoes"), }, ...__VLS_functionalComponentArgsRest(__VLS_7));
    var __VLS_slots;
